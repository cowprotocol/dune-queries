...
, volatility as (
    select
        ...
        , stddev_pop(daily_min_price) over (partition by token_address, blockchain order by date rows between 30 preceding and current row) as stddev_price
...
, filtered as (
    ...
    where
        ...
        and stddev_price / avg_price < 0.01   -- relative volatility < 1%
