...
where
    ...
    or tx_hash = 0x3EC879F27144EA329BC2C671243C831A68796B8221D775D8E0060FD6370B72F1

-- BNB
union all
select distinct tx_hash
from cow_protocol_bnb.trades
where
...
where
    ...
    tx_hash = 0xD492B39F07FD85A791249A2A40A9E59B5BC1859CF3517D72C613E5190E388376
    tx_hash = 0x5E4A89856CE7E7DE36E49A83150B309D0FA309B4F8E215DE89D959A469120F72
    tx_hash = 0x37960545C4D791D3D0A15ADE958C7C206512726F5BED324F0C531ED9E79B508F
    tx_hash = 0x3C98FAC0B4E3948319E178E9C6BD8B8102B6103668C23D81B30F13CE730775C9
    tx_hash = 0x586CDAB4451C48CE894AD416A4F54BACC8DA53F6D080B1F19F528385EAF65A58
