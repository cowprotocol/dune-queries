...
with per_trade_protocol_fees as (
    select
        ...
        cast(cast(coalesce(r.partner_fee, r.protocol_fee) as varchar) as int256) * r.protocol_fee_native_price / pow(10, 18) as raw_integrator_fee_in_eth --noqa: LT02, PRS
...
per_recipient_partner_fees_prelim as (
    select
        ...
        case
            ...
            when '{{blockchain}}' = 'ethereum' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'ethereum' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ethereum' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ethereum' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ethereum' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- gnosis
            ...
            when '{{blockchain}}' = 'gnosis' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'gnosis' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'gnosis' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'gnosis' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'gnosis' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- arbitrum
            ...
            when '{{blockchain}}' = 'arbitrum' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'arbitrum' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'arbitrum' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'arbitrum' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'arbitrum' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- base
            ...
            when '{{blockchain}}' = 'base' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'base' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'base' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'base' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'base' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- avalanche_c
            ...
            when '{{blockchain}}' = 'avalanche_c' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'avalanche_c' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'avalanche_c' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'avalanche_c' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'avalanche_c' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- polygon
            ...
            when '{{blockchain}}' = 'polygon' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'polygon' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'polygon' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'polygon' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'polygon' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- bnb
            ...
            when '{{blockchain}}' = 'bnb' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            ...
            when '{{blockchain}}' = 'bnb' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'bnb' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'bnb' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'bnb' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- linea
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code != 'CoW Swap-SafeApp' then sum(0.9 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x352a3666b27bb09aca7b4a71ed624429b7549551 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xaf1c727b605530acdb00906a158e817f41afd778 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x9c9aa90363630d4ab1d9dbf416cc3bbc8d3ed502 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xcd777a10502256db93c2b0a8e8f64a5174c6cbda then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xe344241493d573428076c022835856a221db3e26 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x8025bacf968aa82bdfe51b513123b55bfb0060d3 then sum(0.45 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xe423c63e8a25811c9cbe71c8585c4505117397c6 then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x1713b79e3dbb8a76d80e038ca701a4a781ac69eb then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xc542c2f197c4939154017c802b0583c596438380 then sum(0.875 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'linea' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- plasma
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code != 'CoW Swap-SafeApp' then sum(0.9 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x352a3666b27bb09aca7b4a71ed624429b7549551 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xaf1c727b605530acdb00906a158e817f41afd778 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x9c9aa90363630d4ab1d9dbf416cc3bbc8d3ed502 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xcd777a10502256db93c2b0a8e8f64a5174c6cbda then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xe344241493d573428076c022835856a221db3e26 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x8025bacf968aa82bdfe51b513123b55bfb0060d3 then sum(0.45 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xe423c63e8a25811c9cbe71c8585c4505117397c6 then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x1713b79e3dbb8a76d80e038ca701a4a781ac69eb then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xc542c2f197c4939154017c802b0583c596438380 then sum(0.875 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'plasma' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
            -- ink
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code != 'CoW Swap-SafeApp' then sum(0.9 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x63695eee2c3141bde314c5a6f89b98e62808d716 and app_code = 'CoW Swap-SafeApp' then sum(0.5 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x352a3666b27bb09aca7b4a71ed624429b7549551 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xaf1c727b605530acdb00906a158e817f41afd778 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x9c9aa90363630d4ab1d9dbf416cc3bbc8d3ed502 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xcd777a10502256db93c2b0a8e8f64a5174c6cbda then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xe344241493d573428076c022835856a221db3e26 then sum(0.85 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x8025bacf968aa82bdfe51b513123b55bfb0060d3 then sum(0.45 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xe423c63e8a25811c9cbe71c8585c4505117397c6 then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x1713b79e3dbb8a76d80e038ca701a4a781ac69eb then sum(0.75 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xc542c2f197c4939154017c802b0583c596438380 then sum(0.875 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x1488281584784fe05f0d7429f82fc487013daa83 then sum(0.7 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x28c716bc23ed77caec27f476a366318ad5f12d58 then sum(0.88 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0xdda155b76fd2793d4ee6eccdd35708d55f3b84da then sum(0.80 * raw_integrator_fee_in_eth)
            when '{{blockchain}}' = 'ink' and partner_recipient = 0x82d7d57c22f56d5f7de062cbca9783001f885302 then sum(0.85 * raw_integrator_fee_in_eth)
