...
select
    ...
    sum(case
        ...
        -- ink
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x63695Eee2c3141BDE314C5a6f89B98E62808d716' then partner_fee_native_token * 0.90
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x352a3666b27bb09aca7b4a71ed624429b7549551' then partner_fee_native_token * 0.85
        when '{{blockchain}}' = 'ink' and partner_recipient = '0xAf1c727B605530AcDb00906a158E817f41aFD778' then partner_fee_native_token * 0.85
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x9c9aA90363630d4ab1D9dbF416cc3BBC8d3Ed502' then partner_fee_native_token * 0.85
    ...
    sum(case
        ...
        -- ink
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x63695Eee2c3141BDE314C5a6f89B98E62808d716' then partner_fee_native_token * 0.10
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x352a3666b27bb09aca7b4a71ed624429b7549551' then partner_fee_native_token * 0.15
        when '{{blockchain}}' = 'ink' and partner_recipient = '0xAf1c727B605530AcDb00906a158E817f41aFD778' then partner_fee_native_token * 0.15
        when '{{blockchain}}' = 'ink' and partner_recipient = '0x9c9aA90363630d4ab1D9dbF416cc3BBC8d3Ed502' then partner_fee_native_token * 0.15
        -- default
