...
prices as (
    select
        ...
        case
            ...
            when '{{blockchain}}' = 'base' and token_address = 0x7Ce02e86354EA0Cc3b302AeAdC0Ab56bC7EB44b8 and hour >= timestamp '2025-10-09 20:00' and hour <= timestamp '2025-10-09 21:00' then 0.8263 -- noqa:CP02
            else price_unit
        end as price_unit,
        case
            ...
            when '{{blockchain}}' = 'base' and token_address = 0x7Ce02e86354EA0Cc3b302AeAdC0Ab56bC7EB44b8 and hour >= timestamp '2025-10-09 20:00' and hour <= timestamp '2025-10-09 21:00' then 0.8263 / pow(10, 18) -- noqa:CP02
            else price_atom
        end as price_atom
    from prices_pre
),
