...
prices as (
    select
        ...
        case
            ...
            when '{{blockchain}}' = 'ethereum' and token_address = 0x5c6Ee304399DBdB9C8Ef030aB642B10820DB8F56 and hour >= timestamp '2025-12-30 03:00' and hour <= timestamp '2025-12-30 04:00' then 2.7
            else price_atom
        end as price_atom
    from prices_pre
),
