...
past_data_ethereum as (
    select
        ...
        d.data.protocol_fee_token, --noqa: RF01
    ...
    from cowswap.raw_order_rewards as d inner join cow_protocol_ethereum.solvers as s on cast(d.solver as varchar) = cast(s.address as varchar) where d.block_number < 20866925
),
...
-- data from Jan 23, 2024 till Sept 23, 2024, are present here
    select --noqa: ST06
        ...
        -1 as auction_id,
        d.block_number,
        cast(d.order_uid as varchar) as order_uid,
        cast(d.solver as varchar) as solver,
        cast(d.quote_solver as varchar) as quote_solver,
        cast(d.tx_hash as varchar) as tx_hash,
        ...
        cast(d.protocol_fee_token as varchar) as protocol_fee_token,
        ...
        cast(d.partner_fee_recipient as varchar) as partner_fee_recipient,
        d.protocol_fee_kind
...
select
    ...
    auction_id,
    block_number,
    cast(order_uid as varchar) as order_uid,
    cast(solver as varchar) as solver,
    cast(quote_solver as varchar) as quote_solver,
    ...
    cast(protocol_fee_token as varchar) as protocol_fee_token,
    ...
    cast(partner_fee_recipient as varchar) as partner_fee_recipient,
    protocol_fee_kind
